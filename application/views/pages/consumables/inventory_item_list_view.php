	...
	$(function(){
		...
		$selectize = $("#item").selectize({
			...
			load: function(query, callback) {
				...
				$.ajax({
					url: '<?php echo base_url(); ?>consumables/inventory_item/search_selectize_items',
					type: 'POST',
					dataType: 'JSON', 
...
<script>
	...
	?>
			   <div class="text-center">
				...
				<?php echo form_open('consumables/inventory_item/edit_inventory_item_list',array('class'=>'form-group','role'=>'form','id'=>'evaluate_applicant')); ?>
				<div class="container">
					<div class="row">
		  ...
		  <?php echo form_open('consumables/inventory_item/edit_inventory_item_list',array('role'=>'form'))   ?>
			<div class="container">
				<div class="row">
			...
			<?php
				...
				foreach($search_inventory_summary as $inventory_item){?>
					...
					?>
						...
						<td><?= $inventory_item->itemwise_sr_no; ?></td>
						<td><?= $issue_date; ?></td>
						<td><?= ($inventory_item->inward_outward === "inward")? "$inventory_item->to_party": ""; ?></td>
						...
						<td>
							<?php 
								if($batch == '0' || $manufacture_date == "" || $expiry_date == "" || 
								$inventory_item->gtin_code == "" || $inventory_item->note == "" || 
								$inventory_item->patient_id) { ?>
								<a href="<?= base_url()."consumables/inventory_item/edit/$inventory_item->inventory_id" ;?>">
									<button class="btn btn-warning" type="button" 
										name="<?= "edit_$inventory_item->inventory_id" ?>">Edit</button>
								</a>
							<?php } ?>
